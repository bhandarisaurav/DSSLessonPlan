    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subjectsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View v, int position, long arg3) {
                ...
                Intent myIntent = new Intent(grade10.this, urlHandler.class);
                myIntent.putExtra("class", "10");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(grade10.this, MainActivity.class);
